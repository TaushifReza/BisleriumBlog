                       ...
                       <div>
                        ...
                        <div>
                            {mode === 'light'
                                ...
                                <>
                                    {/* Light Button  */}
                                    <IconButton onClick={toggleMode} className=" flex justify-center items-center h-10 w-10 rounded-full" style={{ background: mode === 'light' ? '#ced6e0' : '#57606f', color: mode === 'dark' ? 'white' : 'black' }}>
                                ...
                                <>
                                    {/* Dark Button  */}
                                    <IconButton onClick={toggleMode} className=" flex justify-center items-center h-10 w-10 rounded-full" style={{ background: mode === 'light' ? '#ced6e0' : '#57606f' }}>
