                    ...
                    <div className="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 gap-6">
                        ...
                        <div className="xl:col-span-3 lg:col-span-2 lg:m-10 m-5">
                            <div className="text-center">
                                <div>
                                    <h1 className="text-3xl text-sky-600 mb-3">Sign In BisleriumBlog</h1>
                                ...
                                <div className="space-y-5 mt-10">
                                    ...
                                    <a href="forgot-password-2.html" className="text-gray-500 font-medium underline block">Forget Your Password?</a>
