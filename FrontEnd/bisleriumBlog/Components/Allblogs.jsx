      ...
      <div className="container mx-auto py-6">
        ...
        <section className="w-full md:w-2/3 mx-auto px-3">
          <div className="grid md:grid-cols-2 gap-8">
            {blogs.map(blog => (
              <article key={blog.id} className="flex flex-col shadow rounded-lg overflow-hidden">
                {/* Article Image */}
                <a href="#" className="hover:opacity-75">
                  <img src={`https://source.unsplash.com/collection/1346951/1000x500?sig=${blog.id}`} className="w-full h-auto" />
                </a>
                <div className="bg-white flex flex-col justify-start p-6 space-y-3">
                  <a href="#" className="text-blue-700 text-sm font-bold uppercase">Technology</a>
                  ...
                  <a href="#" className="text-xl font-bold hover:text-gray-700">Lorem Ipsum Dolor Sit Amet Dolor Sit Amet</a>
                  <p className="text-sm">
                    By <a href="#" className="font-semibold hover:text-gray-800">David Grzyb</a>, Published on April 25th, 2020
                  </p>
                  <a href="#" className="text-gray-700 hover:text-black">Continue Reading <i className="fas fa-arrow-right"></i></a>
                </div>
              </article>
            ))}
...
{blogs.map(blog => (
          ...
          <div className="flex justify-center items-center space-x-4 py-8">
            <a href="#" className="h-10 w-10 bg-blue-800 hover:bg-blue-600 font-semibold text-white flex items-center justify-center rounded-full">1</a>
            <a href="#" className="h-10 w-10 font-semibold text-gray-800 hover:bg-blue-600 hover:text-white flex items-center justify-center rounded-full">2</a>
            <a href="#" className="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 flex items-center justify-center rounded-full">Next <i className="fas fa-arrow-right ml-2"></i></a>
          </div>
        </section>
      </div>
      <hr></hr>
    ...
    <section className="w-full md:w-2/3 mx-auto text-center px-3 py-8 bg-blue-100 rounded-lg shadow">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Do you want to create a blog?</h2>
