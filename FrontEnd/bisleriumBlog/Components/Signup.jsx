                        ...
                        <div className="xl:col-span-2 lg:col-span-1">
                            <div className="bg-sky-600 text-white gap-10 h-full w-full p-7 space-y-6 lg:space-y-0">
                                ...
                                <div className="flex flex-col justify-center text-center h-full">
                                    ...
                                    <div className="my-8">
                                        <Link to="/signin" className="border text-white font-medium text-sm rounded-full transition-all duration-300 hover:bg-white hover:text-black focus:bg-white focus:text-black px-14 py-2.5">
                                            Sign In
                                        </Link>
                                    </div>
                                </div>
